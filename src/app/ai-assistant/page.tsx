    ...
    <div className="flex flex-col h-[calc(100vh-32px)] animate-fade-in">
      ...
      >
        <div className="flex items-center gap-2">
          {messages.length > 0 && (
            <Button variant="outline" size="sm" className="gap-1.5" onClick={() => setMessages([])}>
      ...
      <div className="flex-1 overflow-y-auto px-1">
        {messages.length === 0 ? (
          ...
          <div className="flex flex-col items-center justify-center h-full max-w-2xl mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3 w-full rounded-xl bg-gradient-to-br from-muted/40 to-muted/10 p-4">
