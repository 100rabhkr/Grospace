...
async def extract_structured_data(text: str, doc_type: str) -> dict:
    ...
    prompt = (
        ...
        "16. For CHARGES section — look for: CAM charges, HVAC, electricity, operating hours, GST. "
        "These may be in a section titled 'Other Charges' or 'Maintenance' or within the rent section.\n"
